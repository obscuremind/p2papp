...
public class GlossyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean isDownloadLive() {
        if (!sharedPref.getCurrent(Callback.TAG_TV).isEmpty()){
            ...
            Toast.makeText(GlossyActivity.this, "Download Live IV", Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    private void getSeries() {
        if (NetworkUtils.isConnected(this)){
            ...
            pb_serials.setVisibility(View.GONE);
            Toast.makeText(GlossyActivity.this, getString(R.string.err_internet_not_connected), Toast.LENGTH_SHORT).show();
        }
    }
